...
const CardItem = ({ item, onAddToCart, isHovered, onHover }) => {
  ...
  const getSelectedPrice = () => {
    if (selectedSize === "S") return item.price_single;
    if (selectedSize === "D") return item.price_double;
    if (selectedSize === "T") return item.price_triple;
    return item.price_single;
  };
...
const PriceTag = ({ label, price, isSelected, onClick }) => (
  <motion.button
