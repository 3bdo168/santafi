...
const Profile = () => {
  ...
  // ✅ اشترك live في أوردرات العميل من all_orders
  useEffect(() => {
    if (activeTab !== "orders" || !clientUser?.uid) {
      return undefined;
    }
    ...
    const unsub = onSnapshot(q, (snap) => {
      ...
      // ترتيب محلي لتفادي مشاكل الـ Firestore composite index
      data.sort((a, b) => {
